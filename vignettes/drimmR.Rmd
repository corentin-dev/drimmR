...
chains introduced in **@Ver08** assume that the Markov transition matrix
...
$i, j \in \{0, 1, \ldots, d\},$ $A_i\begin(\frac{nj}{d}\end)=\mathbb{1}_{\{i=j\}}.$*
:::
...
For a linear drifting Markov chain of order$`<!-- -->`{=html}1$$(X_t)\_0
t n,$the RG-failure rate at time$l at time $l,$ $l \in \mathbb N,$ is
...
::: small
$\displaystyle P_1(H, \boldsymbol{m}, \boldsymbol{n}) = \sum_{t=1}^{m}\sum_{h=1}^H \mathbb{1}_{\{X_{t-1}^h=u \}} \begin(\frac{t}{n}\end)^2,$
$\displaystyle P_2(H, \boldsymbol{m}, \boldsymbol{n}) = \sum_{t=1}^{m} \sum_{h=1}^H\mathbb{1}_{\{X_{t-1}^h=u, X_t^h=v \}} \begin(1-\frac{t}{n}\end),$\
$\displaystyle P_3(H, \boldsymbol{m}, \boldsymbol{n}) = \sum_{t=1}^{m}\sum_{h=1}^H\mathbb{1}_{\{X_{t-1}^h=u \}} \begin(1-\frac{t}{n}\end)\begin(\frac{t}{n}\end),$
$\displaystyle  P_4(H, \boldsymbol{m}, \boldsymbol{n}) = \sum_{t=1}^{m}\sum_{h=1}^H\mathbb{1}_{\{X_{t-1}^h=u, X_t^h=v \}}\begin(\frac{t}{n}\end),$\
$\displaystyle  P_5(H, \boldsymbol{m}, \boldsymbol{n}) = \displaystyle\sum_{t=1}^{m}\sum_{h=1}^H\mathbb{1}_{\{X_{t-1}^h=u \}}\begin(1-\frac{t}{n}\end)^2,$
...
![Figure plot of word probabilities along the sequence between \<start\>
and \<end\> of `pos` argument](wordprobas.png){#wordprobas width="70%"}
...
![image](wordsprobas1.png){width="60%"}
![image](wordsprobas2.png){width="60%"}
![image](wordsprobas3.png){width="60%"}
...
![image](lprobas1.png){width="80%"}
![image](lprobasv2.png){width="103%"}
...
![Figure plot of reliability probabilities along the sequence between
`k1` and `k2` position arguments for the working states subspace `s1`
](rel.png){width="70%"}
...
![Figure plot of availability probabilities along the sequence between
`k1` and `k2` position arguments for the working states subspace `s1`
](ava.png){width="70%"}
...
![Figure plot of BMP-failure rates along the sequence between `k1` and
`k2` position arguments for the working states subspace `s1`
](er.png){width="70%"}
